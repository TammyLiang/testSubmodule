	...
	<div class="luck-draw" v-show="awardList">
		<div class="group-item">
			<div class="gift gift1">
				<img :src="awardList && awardList[0].awardsImage|imgCurrency" class="turn-award">
			</div>
			<div class="gift gift2">
				<img :src="awardList && awardList[1].awardsImage|imgCurrency" class="turn-award">
			</div>
			<div class="gift gift3">
				<img :src="awardList && awardList[2].awardsImage|imgCurrency" class="turn-award">
			</div>
		</div>
		<div class="group-item">
			<div class="gift gift0">
				<img :src="awardList && awardList[7].awardsImage|imgCurrency" class="turn-award">
			</div>
			...
			<div class="gift gift4">
				<img :src="awardList && awardList[3].awardsImage|imgCurrency" class="turn-award">
			</div>
		</div>
		<div class="group-item">
			<div class="gift gift7">
				<img :src="awardList && awardList[6].awardsImage|imgCurrency" class="turn-award">
			</div>
			<div class="gift gift6">
				<img :src="awardList && awardList[5].awardsImage|imgCurrency" class="turn-award">
			</div>
			<div class="gift gift5">
				<img :src="awardList && awardList[4].awardsImage|imgCurrency" class="turn-award">
			</div>
		</div>
...
<style  lang="less">
	...
	.gift {
		...
		background: url(../../images/single/drawprod-bg.png) no-repeat center center;
		background-size: 1.76rem 1.01rem;
		position: relative;
		margin:-0.045rem;
		&.active {
			background: url(../../images/single/drawprod-active-bg.png) no-repeat center center;
			background-size: 1.76rem 1.01rem;
		}
		.turn-award {
			max-width: 70%;
	...
	.cj-gift {
		...
		background-size: 1.92rem 1.1rem;
		position: relative;
		top: 0.05rem;
		.text {
			width: 100%;
